...
@endpush
@section('title')
    {{__('View All Materials Received')}}
@endsection
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fa fa-balance-scale-right">{{__('View All Materials Received')}}</h3>
            </div>

           
                       
                <div class="col-12 mt-5 mb-3" id="searchbox">
                    {{-- @include('core::search',['route'=>'oresreceipt'])  --}}
                        @include('productionorders::oresreceipt/filter',['route'=>'oresreceipt','data'=>$CustomerName,
                        'users'=>$UsersName,'FabricName'=>$FabricName,'Receiver'=>$OresReceiver])
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data">
                    @include('productionorders::oresreceipt/ores_order_table',['Oresorders'=>$Oresorders])
...
$("#filter_btn").click(function(e){
                ...
                $.ajax({
                    url:"{{route('oresreceipt.index')}}",
                    // data:{rows,search,date_from,date_to,Receiver,user_list,fabric,customer_type,order},
                    data:{rows,search,date_from,date_to,Receiver,user_list,fabric,customer_type},
