...
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fa fa-balance-scale-right">{{__('Material Number Store')}}  
                </h3>
            </div>

                <div class="col-12 mt-5 mb-3" id="searchbox">
                        @include('productionorders::delivery_store/filter_quality_and_deliveries',['route'=>'quality_and_deliveries','data'=>$CustomerName,
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data">
                    @include('productionorders::delivery_store/quality_and_deliveries_table',['quality_deliveries'=>$quality_deliveries])
                </div>
 {{-- -------------------------------------------------------------------------------------------- --}}
...
$("#filter_btn").click(function(e){
                ...
                $.ajax({
                    url:"{{route('quality_and_deliveries.index')}}",
