...
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fa fa-balance-scale-right"> {{__('Follow-up Movement')}}</h3>
                ...
                <div class="col-12 mt-5 mb-3" id="searchbox">
                   {{-- @include('core::search',['route'=>'movements']) --}}
                        @include('productionorders::pro_follow_up/filter_movement',['route'=>'movements','data'=>$CustomerName,
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data">
                    @include('productionorders::pro_follow_up/follow_up_table2',['Movements'=>$Movements])
...
$("#filter_btn").click(function(e){
            ...
            //     $.ajax({
            //         url:"{{route('movements.xlsx')}}",
            //         data:{rows,search,date_from,date_to,colors,user_list,fabric,customer_type},
            //         success:function (res) {
            //         //    $(".data").html(res)
            //         window.location.href = "{{route('movements.xlsx')}}";
