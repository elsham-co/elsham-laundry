...
@section('content')
    ...
    <div class="portlet">
            ...
            <form action="{{route('pro_follow_up.update',$tt->id)}}" method="POST" id="update_Transformation" name="update_Transformation" enctype="multipart/form-data" autocomplete="off">
                @method("PUT")
                @csrf
            <!-- BEGIN Form Group -->
...
<div class="float-label float-label-lg">
    ...
    <option value="  ليزر "> ليزر </option>
     <option value="  المطبعه "> المطبعه </option>
    <option value="  العدد "> العدد </option>
    <option value="  الجوده "> الجوده </option>
...
$("#stage1").validate().settings.ignore=[];
            ...
            $('.select2-hidden-accessible')
                ...
                $("#update_Transformation").validate({
          ...
          messages:{
            stage1:'{{__('Production Departments is Required Field...Please Add Production Departments')}}',
            },
                    errorElement: "div",
