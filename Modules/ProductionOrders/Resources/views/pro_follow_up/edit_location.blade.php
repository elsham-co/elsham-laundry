...
@section('content')
    ...
    <div class="portlet">
            ...
            <form action="{{route('activlocation.update',$allorderdata->id)}}" method="POST" id="update_active_order" name="update_active_order"enctype="multipart/form-data" autocomplete="off">
                @method("PUT")
                @csrf
            <!-- BEGIN Form Group -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" autocomplete="off">
                                <div class="float-label float-label-lg">
                                <input type="text" class="form-control" value="{{$allorderdata->number_voucher}}"  id="number_voucher" name="number_voucher" onkeypress="return /[0-9]/i.test(event.key)" autocomplete="off" readonly>
            ...
            <div class="form-group">
               ...
               <div class="col-md-6">
                        <div class="form-group">
                    <div class="float-label float-label-lg">
                        <input type="text" class="form-control" value="{{$allorderdata->data}}" id="customer_code" name="customer_code" onkeypress="return /[0-9]/i.test(event.key)" readonly>
       ...
       <div class="col-md-6">
        <div class="form-group">
    <div class="float-label float-label-lg">
        <input type="text" class="form-control" value="{{$allorderdata->fabric}}" id="fabrics_code" name="fabrics_code" onkeypress="return /[0-9]/i.test(event.key)" readonly>
  ...
  <label for="fabSelect">{{__('Fabrics Name')}} :</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="float-label float-label-lg">
                            <input type="text" class="form-control" value="{{$allorderdata->total}}" id="total" name="total" onkeypress="return /[0-9]/i.test(event.key)" readonly>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="float-label float-label-lg">
                        <input type="text" class="form-control" value="{{$allorderdata->weight}}" id="weight"name="weight" onkeypress="return /[0-9]/i.test(event.key)" readonly>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="float-label float-label-lg">
                    <input type="text" class="form-control" value="{{$allorderdata->totalfashion}}" id="totalfashion"name="totalfashion" onkeypress="return /[0-9]/i.test(event.key)" readonly>
...
<div class="float-label float-label-lg">
    ...
    <input type="text" class="form-control" value="{{$allorderdata->Colors}}" id="colors_code"name="colors_code" onkeypress="return /[0-9]/i.test(event.key)" readonly>
  ...
  <div class="col-md-6">
                <div class="form-group">
                    <div class="float-label float-label-lg">
                    <input type="text" class="form-control" value="{{$allorderdata->location}}" id="location"name="location" >
