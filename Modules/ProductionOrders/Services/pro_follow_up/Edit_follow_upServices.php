...
class Edit_follow_upServices
{
    ...
    FabricInfoRepositoryEloquent $Fabric_info,ColorInfoRepositoryEloquent $Color_info)
{
    $this->user = $user;
...
public function editFollowp($editOresorder)
{
    ...
    $infoOresorder->Colors= $this->Color_info->where('colorcode',$infoOresorder->colors_code)->pluck('colorname')->first();
