...
<div class="menu-item">
    <button
        class="menu-item-link menu-item-toggle  {{cuurentroute('delivery.index','active')}} {{cuurentroute('quality_and_deliveries.index','active')}}">
        <div class="menu-item-icon">
            <i class="fa fa-shopping-cart"></i>
        </div>
        <span class="menu-item-text">{{__('Inventory')}}</span>
        <div class="menu-item-addon">
            <i class="menu-item-caret caret"></i>
             ...
             <div class="menu-submenu">
                ...
                <div class="menu-item">
                    <a href="{{route('quality_and_deliveries.index')}}"
                       class="menu-item-link {{cuurentroute('quality_and_deliveries.index','active')}} ">
                        <span class="menu-item-text">{{__('Material Number Store')}} </span>
                    </a>
                </div>

                <div class="menu-item">
                    <a href="{{route('delivery.index')}}"
                       class="menu-item-link {{cuurentroute('delivery.index','active')}} ">
                        <span class="menu-item-text"> {{__('Customer delivery store')}}   </span>
                    </a>
                </div>
