...
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fas fa-eye-dropper">{{__('Samples In Lab')}}</h3>
            </div>

                    <div class="col-12 mt-3 mb-3" id="searchbox">
                        @include('core::search',['route'=>'inlabSample'])
        ...
        <div class="row justify-content-center" style="height: auto;">  
             <div class="col-xl-3 col-md-6">
                ...
                <div class="card-footer bg-secondary d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="{{route('TestSample.index')}}">{{__('View Details')}}</a>
             ...
             <div class="col-xl-3 col-md-6">
                <div class="card bg-primary text-white mb-4">
                  ...
                  {{-- <div class="card-footer bg-secondary d-flex align-items-center justify-content-between">
                  <a class="small text-white stretched-link" href="{{route('ccategory.index')}}">{{__('View Details')}}</a>
                  <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div> --}}
                </div>
             </div>
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data" id="table1">
                    @include('samples::SamplesCreation/test_sample_inlab_table',['TestSampleInLab'=>$TestSampleInLab])
              </div>
