...
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fa fa-feather">{{__('view all Category Fabrics')}}</h3>
            </div>

           
                       
                {{-- <div class="col-12 mt-5 mb-3" id="searchbox">
                    @include('core::search',['route'=>'Category'])
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data">
                    @include('productioncomponents::Fabrics/Fabcategory_table',['Allfabcategory'=>$Allfabcategory])
              
                </div>
 {{-- -------------------------------------------------------------------------------------------- --}}
 <div class="custom-cm" id="custom-cm">
    <div class="custom-cm__item" id="custom-cm__item1">
        <i class="fa fa-archive">  {{__('Trashed Fabrics Category')}}</i>
    </div>
 </div>
{{-- ---------------------------------------------------------------------------------------------- --}}
            </div>
...
window.location.href = "{{route('Category.trashed.index')}}";
});
