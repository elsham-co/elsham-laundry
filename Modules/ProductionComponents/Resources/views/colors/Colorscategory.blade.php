...
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fa fa-flask">{{__('view all Category Colors')}}</h3>
            </div>

            <div class="col-12 mt-5 mb-3" id="searchbox">
                @include('core::search',['route'=>'ccategory'])
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data">
                    @include('productioncomponents::colors/Colcategory_table',['Allcolcategory'=>$Allcolcategory])
              
                </div>
 {{-- -------------------------------------------------------------------------------------------- --}}
 <div class="custom-cm" id="custom-cm">
    <div class="custom-cm__item" id="custom-cm__item1">
        <i class="fa fa-archive">  {{__('Trashed Colors Category')}}</i>
    </div>
 </div>
{{-- ---------------------------------------------------------------------------------------------- --}}
            </div>
...
function delete_ColorCategory(id) {

var url = '{{route('ccategory.destroy','id')}}'
...
window.location.href = "{{route('ccategory.trashed.index')}}";
});
