...
@section('content')
            ...
            <div class="portlet-header">
                <h3 class="fa fa-flask">{{__('View All Colors')}}</h3>
            </div>

           
                       
                <div class="col-12 mt-5 mb-3" id="searchbox">
                    @include('core::search',['route'=>'colors'])
            ...
            <div class="portlet">
                <div class="portlet-body table-responsive mt-4 data">
                    @include('productioncomponents::colors/colors_table',['Colors'=>$Colors])
              
                </div>
 {{-- -------------------------------------------------------------------------------------------- --}}
 @canany(['restore-colors', 'print_components'])
