...
class FashionCategoryController extends Controller
{
    ...
    public function store(Request $request ,StoreFashionCategoryService $service)
    {
            ...
            'fascategory_code' => ['required','numeric','unique:fashioncategory'], 
            ...
            'fascategory_code.unique'=>__('Fashion Category Code is Unique Field, Please Add Fashion Category Code'),
