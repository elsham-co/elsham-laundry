...
<div class="head_name">
    <h3 class="fas fa-users">  {{__('Edit Customer')}}</h3>
</div>
<br>
    <div class="portlet">
   
        <div class="portlet-body d-flex align-items-center justify-content-center">
            <form action="{{route('Customers.update',$customer->id)}}" method="POST" id="update_customer" enctype="multipart/form-data" autocomplete="off">
           @method('PUT')
            @csrf
            <!-- BEGIN Form Group -->
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$customer->customers_code}}"  id="customers_code" name="customers_code">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$customer->customers_name}}" placeholder="{{__('Please... Enter the Customer Name')}}" id="customers_name" name="customers_name" onkeypress="return /[0-9\/^A-Za-z\u0600-\u06FF/ ]/i.test(event.key)">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="float-label float-label-lg">
                            <input type="text" class="form-control" value="{{$customer->phone1}}" placeholder="{{__('Please... Enter the Phone Number 1')}}" id="phone1" name="phone1" onkeypress="return /[0-9]/i.test(event.key)">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="float-label float-label-lg">
                        <input type="text" class="form-control" value="{{$customer->phone2}}" placeholder="{{__('Please... Enter the Phone Number 2')}}" id="phone2" name="phone2" onkeypress="return /[0-9]/i.test(event.key)">
                        <label for="phone2">{{__('Phone Number 2')}} :</label>
                            ...
                            {{-- <div class="col-md-10"> --}}
                                <div class="form-group">
                                    <div class="float-label float-label-lg">
                                        <input class="form-control form-control-lg" type="email" value="{{$customer->email}}" id="email" name="email" placeholder="Please insert your email">
                        ...
                        <div class="form-group" >
                            <div class="float-label float-label-lg">
                            <textarea rows="3" cols="30" id="customers_notes " class="form-control form-control-lg" name="customers_notes" placeholder="{{__('Please... Enter The Customer Notes')}}">{{$customer->customers_notes}}</textarea>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#update_customer").attr("autocomplete", "off");
